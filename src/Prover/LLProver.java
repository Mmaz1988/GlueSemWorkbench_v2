            ...
            * */
            if (p.getTerm() instanceof LLFormula) {
                ...
                if (f.isNested()) {
                    ...
                    for (Iterator<LLTerm> it = f.assumptions.iterator(); it.hasNext(); ) {
                        HashSet<Integer> newIDs= new HashSet<>();
                        newIDs.add(seq.getNewID());
                        Premise assumptionPremise = new Premise(newIDs,it.next());
        ...
        if (term instanceof LLFormula) {
            ...
            */
            ...
            if (f.getLhs() instanceof LLFormula &&
                ...
                ((LLFormula) dependency).discharges.addAll(assumption.discharges);
